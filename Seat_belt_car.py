...
inpImage = "/home/swati/SVAS/SeatBeltimages/noSeatBelt2.jpg"


# Reading Image
beltCap = cv2.imread(inpImage)
...
if (inpImage == "/home/swati/SVAS/SeatBeltimages/noSeatBelt1.jpg" ):
    edges = cv2.Canny(blur, 20, 850)
elif (inpImage == "/home/swati/SVAS/SeatBeltimages/seatBelt2.jpg" ):
    edges = cv2.Canny(blur, 30, 728)
elif (inpImage == "/home/swati/SVAS/SeatBeltimages/seatBelt3.jpg" ):
       edges = cv2.Canny(blur, 30, 728) 
elif (inpImage == "/home/swati/SVAS/SeatBeltimages/seatBelt4.jpg" ):
    edges = cv2.Canny(blur, 30, 728)
else:    
    edges = cv2.Canny(blur, 30, 728)
